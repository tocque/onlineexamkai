    ...
    <form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" placeholder="每个多选题${multiScore}分" id="add-multiQuestionNum"
                           name="multiQuestionNum" class="wu-text easyui-validatebox"
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'"
    ...
    <form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td align="right">多选题数量:</td>
                <td><input type="text" placeholder="每个多选题${multiScore}分" id="edit-multiQuestionNum"
                           name="multiQuestionNum" class="wu-text easyui-validatebox"
                           data-options="required:true, missingMessage:'请填写考试多选题数量'"></td>
            </tr>
            <tr>
    ...
    */
    function openEdit() {
        ...
        $('#edit-dialog').dialog({
            ...
            onBeforeOpen: function () {
                ...
                $("#edit-multiQuestionNum").val(item.multiQuestionNum);
    ...
    $('#data-datagrid').datagrid({
        ...
        columns: [[
            ...
            {field: 'multiQuestionNum', title: '多选题数量', width: 150},
